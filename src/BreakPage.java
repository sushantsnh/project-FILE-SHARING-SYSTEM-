...
public class BreakPage extends JFrame implements ActionListener
{
	...
	public static void main(String args[])
	{
		...
		bp.setSize(1035,740);
                bp.getContentPane().setBackground(Color.CYAN);
		bp.setVisible(true);
	}
}